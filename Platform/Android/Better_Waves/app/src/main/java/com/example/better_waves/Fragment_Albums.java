...
public class Fragment_Albums extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.albums, container, false);
        rv = (RecyclerView) v.findViewById(R.id.albums_list);
        RecyclerAdapter_Albums recyclerAdapter = new RecyclerAdapter_Albums(getContext(), albums);
